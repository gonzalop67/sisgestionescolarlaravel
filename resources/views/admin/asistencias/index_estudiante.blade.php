                                            ...
                                            <tr>
                                                @if (
                                                    $asignacion->gestion_id == $matricula->gestion_id &&
                                                        $asignacion->turno_id == $matricula->turno_id &&
                                                    ...
                                                    <td>{{ $asignacion->personal->apellidos . ' ' . $asignacion->personal->nombres }}
                                                    <td>{{ $asignacion->materia->nombre }}</td>
                                                    <td>
                                                        <a href="{{ url('/admin/asistencias/detalle/asignacion/' . $asignacion->id . '/estudiante/' . $estudiante->id) }}" class="btn btn-success"><i class="fas fa-list-alt"></i> Ver
                                                            asistencia</a>
                                                    </td>
                                                @endif
                                            </tr>
