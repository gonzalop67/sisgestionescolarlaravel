                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="text-center">
                                    <img src="{{ url('storage/' . $formacion->archivo) }}" id="preview"
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <select name="nivel" id="nivel" class="form-control" required>
                                                ...
                                                <option value="Técnico"
                                                    {{ old('nivel', $formacion->nivel) == 'Técnico' ? 'selected' : '' }}>
                                                    Técnico</option>
                                                <option value="Licenciatura"
                                                    {{ old('nivel', $formacion->nivel) == 'Licenciatura' ? 'selected' : '' }}>
                                                    Licenciatura
                                                </option>
                                                <option value="Maestría"
                                                    {{ old('nivel', $formacion->nivel) == 'Maestría' ? 'selected' : '' }}>
                                                    Maestría</option>
                                                <option value="Doctorado"
                                                    {{ old('nivel', $formacion->nivel) == 'Doctorado' ? 'selected' : '' }}>
                                                    Doctorado</option>
                                            </select>
                                            @error('nivel')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="date" name="fecha_graduacion" id="fecha_graduacion"
                                                class="form-control"
                                                value="{{ old('fecha_graduacion', $formacion->fecha_graduacion) }}"
                                                required>
                                        </div>
