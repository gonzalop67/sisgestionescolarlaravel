        ...
        @foreach ($gestiones as $gestion)
            <div class="col-md-3 col-sm-6 col-12">
                <div class="info-box zoomP">
                    <img src="{{ url('/img/calendar.gif') }}" width="70px" alt="">
                    <div class="info-box-content">
                        <span class="info-box-text"><b>Gestiones Educativas</b></span>
                        <span class="info-box-number"
                            style="color: rgb(12, 133, 247); font-size: 18pt;">{{ $gestion->nombre }}</span>
                        <div class="form-group">
                            ...
                            <form action="{{ url('/admin/gestiones/' . $gestion->id) }}" method="POST" id="miFormulario{{ $gestion->id }}" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger btn-sm" onclick="preguntar{{ $gestion->id }}(event)"><i
