                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="gestion_id_create">Gestiones</label><b> (*)</b>
                                            ...
                                            <div class="row d-flex justify-content-center">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <label
                                                                                    for="gestion_id">Gestiones</label><b>
                                                                                    (*)</b>
                                                                                <div class="input-group">
                                                                                    <div class="input-group mb-3">
                                                                                        <div class="input-group-prepend">
                                                                                        ...
                                                                                        <select class="form-control"
                                                                                            ...
                                                                                            @foreach ($gestiones as $gestion)
                                                                                                <option
                                                                                                    value="{{ $gestion->id }}"
                                                                                                    {{ $gestion->id == $periodo->gestion_id ? 'selected' : '' }}>
                                                                                                    {{ $gestion->nombre }}
                                                                                                </option>
                                                                                            @endforeach
                                                                                        </select>
                                                ...
                                                <form action="{{ url('/admin/periodos/' . $periodo->id) }}"
                                                    ...
                                                    <button type="submit" style="margin: 3px" class="btn btn-danger btn-sm"
                                                        onclick="preguntar{{ $periodo->id }}(event)"><i
