...
Route::get('/admin/asistencias/asignacion/{id}', [AsistenciaController::class, 'show'])->name('admin.asistencias.show')->middleware('auth', 'can:admin.asistencias.show');
Route::get('/admin/asistencias/detalle/asignacion/{id_asignacion}/estudiante/{id_estudiante}', [AsistenciaController::class, 'show_estudiante'])->name('admin.asistencias.show_estudiante')->middleware('auth', 'can:admin.asistencias.show_estudiante');
...
Route::put('/admin/asistencias/{id}', [AsistenciaController::class, 'update'])->name('admin.asistencias.update')->middleware('auth', 'can:admin.asistencias.update');
Route::delete('/admin/asistencias/{id}', [AsistenciaController::class, 'destroy'])->name('admin.asistencias.destroy')->middleware('auth', 'can:admin.asistencias.destroy');
